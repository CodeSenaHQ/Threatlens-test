        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pb-1">
          ...
          <div>
            <button
              ...
              className="px-4 py-2 rounded-lg bg-[#1e5adb] hover:bg-[#1849b8] text-white font-semibold text-xs shadow-[0_0_16px_rgba(30,90,219,0.35)] transition-all cursor-pointer flex items-center gap-2"
            >
          ...
          <div className="w-full max-w-xl bg-[#0e1622] border border-[#23344b] rounded-2xl p-6 shadow-2xl space-y-5 animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="p-3.5 rounded-xl bg-[#080d14] border border-[#202e40] text-xs font-mono text-[#38bdf8] leading-relaxed">
